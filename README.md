...
| AS5600 + магнит | - | Магнитный энкодер для точного позиционирования |
| INA219 | - | Датчик тока и напряжения для защиты |
| Mini360 | - | Понижающий DC-DC преобразователь |
| DRV8871 | - | Драйвер двигателя с поддержкой PWM |
